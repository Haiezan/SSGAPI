...
extern "C" _SSG_DLLIMPEXP BOOL DeleteFilesExcept(const CString &sName, const CString &sExt);  //删除多个文件，不删除目录，可以采用匹配符*
...
extern "C" _SSG_DLLIMPEXP int  CopyDirectoryFiles(const CString &sourceDir,const CString &destDir,BOOL bFailIfExists);  //复制目录下的所有文件
